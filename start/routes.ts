...
import CrewsController from '#controllers/crews_controller'
...
/*Crew routes*/
router.post('/crew/post', [CrewsController, 'crewCreated'] )
router.get('/crew/getAll', [CrewsController, 'getAll'] )
router.get('/crew/getOn/:id', [CrewsController, 'getOnly'] )
router.put('/crew/update/:id', [CrewsController, 'updated'] )
router.delete('/crew/delete/:id', [CrewsController, 'deleted'] )
...
router.get('/uploads/*', [PostsController, 'imgeStore'])
